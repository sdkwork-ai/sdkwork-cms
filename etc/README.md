# sdkwork-cms Source Configuration
...
| `appId` | `sdkwork-cms` |
| `runtimeCode` | `cms` |
| Config root | `/etc/sdkwork/cms/` |
| Runtime TOML | `/etc/sdkwork/cms/config.toml` |
| Secrets | `/etc/sdkwork/cms/secrets/` |
| Override | `SDKWORK_CMS_CONFIG_FILE` |
