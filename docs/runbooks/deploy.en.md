# Runbook — sdkwork-cms deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-cms-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-cms/bundle`, loads the image, starts
