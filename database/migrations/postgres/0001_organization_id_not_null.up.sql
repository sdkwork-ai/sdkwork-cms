...
ALTER TABLE cms_site ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_channel ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_content_type ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_content_field ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_taxonomy ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_taxonomy_term ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry_body ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry_field_value ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry_version ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry_media ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_entry_term ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_page ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_page_block ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_publish_snapshot ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_feed ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_feed_rule ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_feed_item ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_feed_snapshot ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_audit_log ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_outbox_event ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
...
ALTER TABLE cms_idempotency_key ADD COLUMN IF NOT EXISTS organization_id BIGINT NOT NULL DEFAULT 0;
